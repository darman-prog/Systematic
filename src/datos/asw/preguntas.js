...
const preguntas = [
  {
    ...
    correct: 1,
    exp: "<b>La POO</b> es un paradigma que agrupa datos y comportamiento en <b>objetos</b>, los cuales se crean a partir de «planos» llamados <b>clases</b>. Piensa en la clase como el molde de galletas y en los objetos como las galletas que salen de él."
  },
  {
    id: "ASW-002",
    parcial: "Parcial 1",
    ...
    dificultad: "facil",
    tipo: "multiple",
    q: "¿Cuál de los siguientes NO es uno de los pilares fundamentales de la POO?",
  ...
  },
  {
    ...
    dificultad: "dificil",
    tipo: "ordenar",
    q: "Ordena las relaciones entre objetos de MENOR a MAYOR intimidad/acoplamiento:",
    bloques: [
  ...
  },
  {
    ...
    dificultad: "facil",
    tipo: "multiple",
    q: "¿Cuál de los siguientes es uno de los principios fundamentales del diseño de software orientado a objetos?",
    options: [
  ...
  },
  {
    ...
    dificultad: "facil",
    tipo: "multiple",
    q: "¿Qué sugiere el principio de diseño conocido como «favorecer la composición sobre la herencia»?",
    options: [
    ...
    correct: 2,
    exp: "Este principio pide <b>favorecer la composición sobre la herencia</b>: componer objetos es más flexible que heredar, porque no te ata a jerarquías rígidas y te permite cambiar comportamiento combinando piezas."
  },
  {
    id: "ASW-014",
    parcial: "Parcial 1",
  ...
  },
  {
    ...
    dificultad: "media",
    tipo: "ordenar",
    q: "Ordena los pasos del flujo general del algoritmo en un ejemplo típico de Template Method (procesamiento de archivos PDF, DOCX y CSV):",
    bloques: [
      "Abrir el archivo",
  ...
  },
  {
    ...
    dificultad: "media",
    tipo: "multiple",
    q: "¿Qué problema aparece si creas e inicializas de inmediato, al arrancar la aplicación, un objeto que consume muchos recursos (una consulta pesada a base de datos o la descarga de un archivo grande)?",
    options: [
      "El objeto real pierde su interfaz y el cliente ya no puede llamarlo",
      "Se desperdician memoria y recursos si el usuario finalmente no usa esa funcionalidad, y no hay un lugar limpio para verificar permisos, aplicar caché o registrar auditorías antes de la operación",
      "El objeto se clona automáticamente y provoca una explosión de clases",
      "El compilador duplica el constructor y la aplicación tarda más en iniciar"
    ],
    correct: 1,
  ...
  },
  {
    ...
    dificultad: "media",
    tipo: "multi",
    q: "Según la clasificación tradicional de los patrones de diseño (GoF), selecciona TODOS los patrones que son CREACIONALES:",
  ...
  },
  {
    ...
    bloques: [
      "El manejador actual evalúa la petición",
      "Si puede (o debe) procesarla, la procesa",
      "Decide si corta el flujo o llama al siguiente manejador de la cadena",
      "El siguiente manejador repite el mismo proceso"
    ],
    exp: "En <b>Chain of Responsibility</b> cada manejador implementa una interfaz común y <b>guarda una referencia al siguiente</b>: evalúa, procesa si corresponde y decide si corta o continúa. Así se evita el bloque enorme de <b>if/else frágil y acoplado</b>."
  },
  {
    id: "ASW-038",
    parcial: "Parcial 1",
    ...
    options: [
      "A nivel de paquete y a nivel de módulo",
      "A nivel de base de datos y a nivel de red",
      "A nivel de método (extraer el comportamiento que cambia a un método separado) y a nivel de clase (aislar lo que varía en unas pocas clases)",
      "A nivel de compilación y a nivel de ejecución"
    ],
    correct: 2,
  ...
  },
  {
    ...
    dificultad: "media",
    tipo: "multiple",
    q: "¿Por qué conviene componer comportamientos mediante delegación en lugar de construir jerarquías de herencia profundas?",
    options: [
      "Porque la herencia está prohibida en los lenguajes orientados a objetos",
      "Porque la composición permite cambiar el comportamiento en tiempo de ejecución, combinar responsabilidades con flexibilidad y evita la fragilidad de las jerarquías, donde un cambio en la clase padre puede romper a todas las subclases",
      "Porque la composición elimina la necesidad de escribir interfaces",
  ...
  },
  {
    ...
    dificultad: "facil",
    tipo: "multiple",
    q: "Una interfaz en programación se puede comparar con «las reglas de un juego». ¿Qué significa esa analogía?",
    options: [
      "Obliga a que todos los personajes del juego tengan exactamente el mismo comportamiento",
      "Define qué acciones debe poder hacer un personaje, pero no dice cómo las hace",
      "Es una lista de errores que el compilador debe reportar antes de ejecutar",
      "Es el contrato que fija el precio de las suscripciones del juego"
    ],
    correct: 1,
    exp: "La interfaz dice <b>qué</b> debe poder hacerse, pero no <b>cómo</b>: así el código cliente no depende de la implementación concreta y el cambio futuro es más fácil. Es <b>polimorfismo</b> aplicado a través de interfaces."
  },
  {
    id: "ASW-041",
    parcial: "Parcial 1",
  ...
  },
  {
    ...
    dificultad: "facil",
    tipo: "multiple",
    q: "Dado que «el cambio es lo único constante» en la vida de un programador, ¿cuál es una de las formas más habituales de reducir los costos de desarrollo?",
    options: [
      "Reescribir los módulos desde cero en cada proyecto para evitar dependencias",
      "Reutilizar el código existente en nuevos proyectos",
      "Congelar los requisitos para que nada cambie después del lanzamiento",
      "Elegir un lenguaje de programación que no necesite actualizaciones"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Que todas las clases del programa hereden de una única clase raíz",
      "Que un objeto pueda cambiar de clase durante la ejecución del programa",
      "Que los métodos privados puedan invocarse desde cualquier otra clase",
      "Que objetos de clases distintas puedan tratarse de forma uniforme a través de una misma interfaz o clase base, y que el objeto concreto decida en tiempo de ejecución cómo responder a cada mensaje"
    ],
    correct: 3,
  ...
  },
  {
    ...
    dificultad: "media",
    tipo: "multiple",
    q: "Además de esconder partes de su estado y comportamiento, ¿qué otros efectos tiene la encapsulación?",
    options: [
      "Convierte automáticamente la clase en abstracta",
      "Protege los datos internos de accesos no deseados y reduce el acoplamiento entre componentes",
      "Garantiza que los métodos se ejecuten más rápido",
      "Elimina la necesidad de usar interfaces en el resto del programa"
    ],
    correct: 1,
  ...
  },
  {
    ...
    dificultad: "dificil",
    tipo: "relacionar",
    q: "Relaciona cada relación entre objetos con su descripción correcta:",
    pares: [
    ...
    exp: "La escalera de intimidad entre objetos: <b>dependencia</b> (ni siquiera conoce), <b>asociación</b> (conoce, no contiene), <b>agregación</b> (contiene pero sin control del ciclo de vida) y <b>composición</b> (contiene y controla el ciclo de vida)."
  },
  {
    id: "ASW-046",
    parcial: "Parcial 1",
    ...
    options: [
      "Modificando directamente su código interno para cubrir los nuevos casos",
      "Haciendo públicos todos sus atributos para facilitar los cambios futuros",
      "Mediante herencia, decoradores o composición, sin modificar su código interno; algunos lenguajes incluso permiten restringir la extensión con palabras clave como final",
      "Renombrando la clase y publicándola de nuevo como versión 2"
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      "Forzar condiciones imposibles",
      "Añadir nuevos métodos o campos propios",
      "Cambiar precondiciones o postcondiciones de forma incompatible",
      "Lanzar excepciones que el cliente no espera"
    ],
    correctos: [0, 2, 3],
